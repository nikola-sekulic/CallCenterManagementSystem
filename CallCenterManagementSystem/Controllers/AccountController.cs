    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.AddToRoleAsync(user.Id, "Specialist");*/


                    UserManager.AddToRole(user.Id, RoleName.AgentRoleName);
        ...
        public async Task<ActionResult> RegisterEmployee(EmployeeFormViewModel viewModel)
        {
            if(ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (viewModel.DesignationId == Designation.Agent)
                    {
                        UserManager.AddToRole(user.Id, RoleName.AgentRoleName);
                        ...
                        {
                            Name = viewModel.Name,
                            DateStarted = viewModel.DateStarted,
                            DateEnded = viewModel.DateEnded,
                    ...
                    {
                        UserManager.AddToRole(user.Id, RoleName.SpecialistRoleName);
